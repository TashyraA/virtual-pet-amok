...
public class VirtualPetShelterApp {
    ...
    public static void main(String[] args) {
        ...
        Cat pet1 = new Cat(1, "Bandit", "big fluffy cat", 10, 0, 0, 0, 0);
        Dog pet2 = new Dog(2, "Poncho", "the sweet pitbull", 10, 0, 0, 0, 0);
        RoboticPet pet3 = new RoboticPet(3, "Precious", "the roborabbit", 10, 0);
        ...
        while (true) {
            ...
            if (menuOption.toLowerCase().contentEquals("help")) {
                ...
                for (VirtualPet currentPet : petStats) {
                    ...
                    if (currentPet instanceof OrganicPet) {
                        ...
                        System.out.println(currentPet.getPetName() + "\t|   " + currentPet.getHealth()
                                ...
                                + ((RoboticPet) currentPet).getRustLevel());
                    }
                }
                ...
                if(petType.toLowerCase().contentEquals("cat")) {
                    ...
                    VirtualPet petToIntake = new RoboticPet(0, petName, petDescription,0, 0);
                    myPets.add(petToIntake);
    ...
    private static void printGreeting() {
        ...
        System.out.println("*     Welcome to the Pet Shelter!       *"
                + "\n* Home for cats, dogs, and Electric robo-pets *");
        System.out.println("*                                            *");
        System.out.println("********************************************** \n");
